...
const routes: Route[] = [
  {
    ...
    length: '880m',
    firstAscent: '1958',
    description: 'The Nose is the most famous route on El Capitan.'
  },
  {
    id: 2,
    name: 'La Rambla',
    location: 'Siurana, Catalonia, Spain',
    latitude: 41.2422,
    longitude: 0.9633,
    grade: '5.15a',
    type: 'Sport',
    length: '35m',
    firstAscent: '2003',
    description: 'A classic hard sport climb in Spain.'
  }
];
...
const events: Event[] = [
  {
    id: 1,
    name: 'Yosemite Big Wall Festival',
    location: 'Yosemite Valley, California, USA',
    latitude: 37.7489,
    longitude: -119.5882,
    date: '2025-09-14',
    description: 'A celebration of big wall climbing with workshops and guest speakers.'
  },
  {
    id: 2,
    name: 'Red River Gorge Gathering',
    location: 'Slade, Kentucky, USA',
    latitude: 37.7915,
    longitude: -83.6819,
    date: '2025-10-05',
    description: 'An annual event for climbers at Red River Gorge.'
  }
];
...
const gyms: Gym[] = [
  {
    ...
    latitude: 40.6795,
    longitude: -73.9832,
    features: ['Bouldering', 'Top Rope', 'Lead Climbing', 'Fitness Area'],
    description: 'A vibrant community climbing gym.'
  },
  {
    id: 2,
    name: 'B-PUMP Ogikubo',
    ...
    latitude: 35.7052,
    longitude: 139.6203,
    features: ['Bouldering', 'Competition Walls'],
    description: 'Japan’s most famous bouldering gym.'
  }
];
